...
export default function Contract({ personalData, onConfirm }: ContractProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded shadow overflow-y-auto" style={{ maxHeight: '70vh' }}>
      <h2 className="text-xl font-bold mb-4">Contract Preview</h2>
      ...
      <label className="flex items-center mb-4">
        ...
        <span className="ml-2">Zaškrtnutím tohto políčka prehlasujem, že som si zmluvu riadne prečítal/a a súhlasím s hore uvedenými zmluvnými podmienkami.</span>
      </label>
      <button
